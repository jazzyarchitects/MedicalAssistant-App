...
import architect.jazzy.medicinereminder.Handlers.ExportToXML;
 ...
 */
public class BasicPreferences extends PreferenceActivity {
	/**
    ...
    {
        return BasicPreferences.class.getName().equals(fragmentName);
    }
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
        /*android.support.v7.app.ActionBar actionBar=get
	...
	private void setupSimplePreferencesScreen() {
		...
		preference.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
			...
			public boolean onPreferenceClick(Preference preference) {
				ImportToSQL.importData(BasicPreferences.this);
				return false;
			}
		});
		...
		exportPref.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
			@Override
			public boolean onPreferenceClick(Preference preference) {
				ExportToXML.exportData(BasicPreferences.this);
				return false;
			}
		});
        ...
        deletePref.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            @Override
            public boolean onPreferenceClick(Preference preference) {
                DeleteAllMedicines object=new DeleteAllMedicines(BasicPreferences.this);
	...
	public static class NotificationPreferenceFragment extends PreferenceFragment {
		...
		public void onCreate(Bundle savedInstanceState) {
			...
			// updated to reflect the new value, per the Android Design
			// guidelines.
            bindPreferenceSummaryToValue(findPreference("popup_ringtone"));
